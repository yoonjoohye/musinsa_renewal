  ...
  <section class="w-screen min-h-screen flex justify-center">
    <div class="container py-10">
      ...
      <div class="border-b py-10">
        <div class="flex justify-center mb-8">
          <div class="w-full flex flex-col items-center">
            <div class="text-2xl text-center font-light">신규 입점 브랜드</div>
          </div>
          <span class="text-gray-500 w-20">보러가기 ></span>
        </div>
        <div class="flex justify-center justify-between">
          <div class="flex flex-col justify-center items-center" v-for="x in 5" v-bind:key="x">
            <Brand :index="x"></Brand>
            <span class="border rounded px-2 py-1">응원하기</span>
          </div>
        </div>
      </div>
      ...
      <div class="border-b py-10">
        ...
        <div class="masonry">
          <Style v-for="x in 6" v-bind:key="x" :index="x"></Style>
        </div>
      </div>
...
<script>
    ...
    export default {
        components: {
            Rank, Today, Style, Sale, Banner, Designer, Brand
        },
        data(){
            return{
                today:false,
